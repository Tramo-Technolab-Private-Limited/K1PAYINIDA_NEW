...
import DMTRemitterDetail from "./TransferRemitterDetail";
import DMTbeneficiary from "./Transferbeneficiary";
          ...
          <Grid item sm={3}>
            <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
              ...
              <Typography variant="body2" sx={{ ml: 1 }}>
                ...
                mandatory for transfer. Please ensure you provide a valid sender
